...
- **Metric evidence:** IOPS, bandwidth, and latency always show units and useful context. Active metrics name `fio stdout/status`; persisted metrics name `stats.jsonl`, with sample count and live/persisted capture mode nearby.
